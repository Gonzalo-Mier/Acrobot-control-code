function [ fitness ] = f_LQR( K, p_ini, params )
...
for t = 0:dt_controller:t_total
    ...
    x= [mod(q1-pi-pi,2*pi)-pi; mod(q2-pi,2*pi)-pi; dq1; dq2];
    F = -K*x;
...
%     w = [1 1 0.1 0.1 1 10 0.1 0.1 1/10/F_max]/length(q1_t);
    w = [0 0 0 0 1 2 .1 .1 1/F_max/100]/length(q1_t);
